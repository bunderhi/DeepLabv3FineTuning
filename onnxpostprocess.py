...
def post_process_packnet(model_file, opset=11):
    ...
    onnx.save_model(gs.export_onnx(graph), '/models/run03/jetracerpost.onnx')
...
def main():
    ...
    parser.add_argument("-o", "--output", help="Path to save the generated ONNX model", default="/models/run03/jetracer.onnx")
